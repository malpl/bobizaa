...
*—◉ المثال:*
مالك بيحبك ده لينك الروم بتاعي<https://chat.whatsapp.com/CUyxsz7kb7nCJLIocNoGeC 🧛💜>
.ds
.ds
.ds*—◉ Ejemplo:*\n${usedPrefix}s\n${usedPrefix}s\n${usedPrefix}s`}, {quoted: m});  
};
handler.help = ['صلح'];
handler.tags = ['فك تشفير البوت'];
handler.command = /^(صلح|تصليح|فك-تشفير)$/i;
